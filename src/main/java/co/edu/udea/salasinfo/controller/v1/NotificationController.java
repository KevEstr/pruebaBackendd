...
public class NotificationController {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<NotificationResponse> deleteById(@PathVariable("id") Long notificationId) {
        return ResponseEntity.ok(notificationService.deleteById(notificationId));
    }
}
